...
from .sql_queries import get_pending_received_requests, get_pending_sent_requests, accept_friend_request, reject_friend_request, cancel_friend_request

def requests_view(request):
    username = request.session['username']
    received_requests = get_pending_received_requests(username)
    sent_requests = get_pending_sent_requests(username)
    return render(request, "requests.html", {'received_requests':received_requests, 'sent_requests':sent_requests})
